# Adjusted from Stand-Alone-Self-Attention
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, groups=1, base_width=64):
        ...
        self.conv2 = nn.Sequential(
            AttentionConv(in_channels, width, kernel_size=7, padding=3, groups=8),
        ...
        out = out_channels * self.expansion * base_width
        self.lin = nn.Linear(out, 256)
